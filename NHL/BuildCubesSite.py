...
from batch_gnome import tap_mod, oil_weathering, tap_comp_volume
from MudFlatCubes import comp_volume_mf, CompThicknessCube_mf
...
def main(RunSite, RootDir, CubesPath, CubesRootNames, CubeType, CubeDataType, Seasons, TrajectoriesPath,
    ...
    for ((Season, Months), CubeRootName) in zip(Seasons, CubesRootNames):
        ...
        CubeName_mf = os.path.join(RootDir, CubesPath_mf, Season, "%s%s%s" % (CubeRootName, d[4:7].zfill(4), ".bin"))
        ...
        for TrajFilesDir, CubeName, CubeName_mf, Months in CubesList:
            ...
            if CubeExists and (os.path.getsize(CubeName) > 0):
                ...
                if CubeType == "Cumulative":
                    ...
                    Cube, Cube_mf = CompThicknessCube_mf(TrajFiles,
                                                         OutputTimes,
                                                         Receptors,
                                                         oil_weathering.OilTypes[OilWeatheringType])
                    ...
                    try:
                        ...
                        Cube_mf = tap_mod.transform(Cube_mf, NumLEs, n=1.5, dtype=types[CubeDataType])
                    except KeyError:
