...
def main(RootDir, MapName, MapFileName, CubesRootNames, MapFileType, NumStarts, Seasons, StartSites,
...
if __name__ == '__main__':
    ...
    main(tap.RootDir, tap.MapName, tap.MapFileName, tap.CubesRootNames, tap.MapFileType, tap.NumStarts,
